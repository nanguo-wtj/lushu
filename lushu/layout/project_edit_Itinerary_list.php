<div class="plannerMain__cell___2Vav9 enter-brief" style="left:calc((100% - 240px) * 0.3333 + 208px);width:calc((100% - 240px) * 0.3333);z-index:10">
    <div class="plannerMain__plannerPanelWrap___3vIXb
                    plannerMain__default___Le6uz">
        <div class="plannerPanel__plannerPanel___3vpy8
                      overview__panel___B44Tg">
            <div class="plannerPanel__header___3iE-t">
                <h2>行程介绍</h2>
                <div class="plannerPanel__headerActions___2-0JG">
                    <button type="button" class="ant-btn ant-btn-primary" v-on:click="OpenItinerary()">
                        <span>编辑</span>
                    </button>
                </div>
            </div>
