                            ...
                            <div class="pagePanel
                                ...
                                <div class="poiBasicInfo__leftElt___LuZys">
                                    <div class="poiBasicInfo__header___1ghKY">
                                        ...
                                        <button v-on:click="Hotel_add()" type="button" class="ant-btn poiBasicInfo__editButton___3-iPI ant-btn-primary">
                                            <span>编辑</span>
                                        </button>
                                    </div>
                                    <div class="poiBasicInfo__leftContent___1GiUF">
                                        ...
                                        <div class="keyValueDivider__container___3EuXB" v-if="resources_data.guide">
                                            <div class="keyValueDivider__key___3-UHy">酒店政策</div>
                                            <div class="keyValueDivider__value___2TZgL" v-html="resources_data.policy"></div>
                                        </div>
                                        <div class="keyValueDivider__container___3EuXB" v-if="resources_data.guide">
