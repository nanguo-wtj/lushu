...
<!--                                                </i>-->
                                    ...
                                    <span class="contentBase__editContainer___3yjO8">
                                        <button v-on:click="open_project" type="button" class="ant-btn contentBase__button___kuoT2 ant-btn-plain">
                                                ...
                                                <div class="tripEditPreview__sectionSub___1mgKs">
                                                    ...
                                                    <div>
                                                        <div class="ant-carousel">
                                                            <div class="slick-slider tripEditPreview__hotelSlider___TQGjo slick-initialized" style="padding-bottom: 0px" dir="ltr">
                                                                <div class="slick-list" >
                                                                    <div class="slick-track" style="opacity: 1;">

                                                                         <el-carousel :interval="4000" type="card" height="256px">
                                                                            <el-carousel-item v-for="(item,index) in project_list.OverviewOfItinerary.Highlights"  :key="index" class="slick-slide " tabindex="-1" style="outline: none;height: 256px; width: 500px;">
                                                                              <div>
                                                                                <div class="keypoint__keypoint___18gVZ tripEditPreview__keypoint___PG2hj" style="width: 100%; display: inline-block;" :data-index="index" v-on:click="Getdetails_Tripdata(item.id)">
