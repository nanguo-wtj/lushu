        ...
        methods: {
            GetResourcesdata:function (e) {
                ...
                post_url(url,{key_id:_that.key_id},false,true).then(res => {
                    ...
                    _that.project_note_data.hotel.push(str)
                    _that.project_picture_data.hotel.push(str)
            ...
            del_association:function (e){
                var _that   =   this;
                _that.project_note_data.hotel.splice(e, 1);
            ...
            post_note:function () {
                ...
                post_url(url,_that.project_note_data,true).then(res => {
                    ...
                    _that.project_note_data.hotel.push(association)
            ...
            post_picture:function () {
                ...
                post_url(url,_that.project_picture_data,true).then(res => {
                    ...
                    _that.project_picture_data.hotel.push(association)
                },error=>{
                });
            },
            post_picture_default:function (e) {
                ...
                var _that   =   this;
                const url   =   "<?=$_Post_url?>?cmd=resource_img&list=default_hotel";
                var data    =   {
                    key_id:_that.key_id,
                    picture_id:e.id
                }
