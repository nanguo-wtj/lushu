    ...
    new Vue({
        ...
        methods: {
            ...
            GetProject_Cost:function () {
                var _that   =   this;
                const url   =   "<?=$_Post_url?>?cmd=export_information&list=Cost";
            ...
            openCostEdit:function (e,a,b,c) {
                ...
                const url   =   "<?=$_Post_url?>?cmd=export_information&list=GetDayClassCost";
            ...
            post_cost:function () {
                var _that   =   this;
                const url   =   "<?=$_Post_url?>?cmd=export_information&list=AddDayClassCost";
