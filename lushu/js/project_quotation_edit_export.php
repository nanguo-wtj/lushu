    ...
    new Vue({
        ...
        methods: {
            ...
            GetQuotationList:function () {
                var _that = this;
                const url   =   "<?=$_Post_url?>?cmd=export_quotation&list=quotation";
            ...
            Setopenquotation:function () {
                ...
                const url   =   "<?=$_Post_url?>?cmd=export_quotation&list=quotation_type";
                post_url(url,{key_id:_that.key_id},false).then(res => {
            ...
            Setquotation:function () {
                ...
                console.log(code)
                const url   =   "<?=$_Post_url?>?cmd=export_quotation&list=classification";
            ...
            post_time:function () {
                var _that =   this;
                const url   =   "<?=$_Post_url?>?cmd=export_quotation&list=setTime";
            ...
            GetConstList:function () {
                var _that = this;
                const url   =   "<?=$_Post_url?>?cmd=export_quotation&list=Const";
                post_url(url,{key_id:_that.key_id},false).then(res => {
            ...
            Post_const:function () {
                var _that =   this;
                const url   =   "<?=$_Post_url?>?cmd=export_quotation&list=setConst";
            ...
            GetNotIncludedList:function () {
                var _that = this;
                const url   =   "<?=$_Post_url?>?cmd=export_quotation&list=NotIncluded";
                post_url(url,{key_id:_that.key_id},false).then(res => {
            ...
            Post_NotIncluded:function () {
                var _that =   this;
                const url   =   "<?=$_Post_url?>?cmd=export_quotation&list=setNotIncluded";
            ...
            GetPaidItemsList:function () {
                var _that = this;
                const url   =   "<?=$_Post_url?>?cmd=export_quotation&list=PaidItems";
                post_url(url,{key_id:_that.key_id},false).then(res => {
            ...
            Post_PaidItems:function () {
                var _that =   this;
                const url   =   "<?=$_Post_url?>?cmd=export_quotation&list=setPaidItems";
            ...
            GetSupplementList:function () {
                var _that = this;
                const url   =   "<?=$_Post_url?>?cmd=export_quotation&list=supplement";
                post_url(url,{key_id:_that.key_id},false).then(res => {
            ...
            Post_supplement:function () {
                var _that =   this;
                const url   =   "<?=$_Post_url?>?cmd=export_quotation&list=setsupplement";
            ...
            Del_quotation:function (e,type) {
                ...
                var _that =   this;
                const url   =   "<?=$_Post_url?>?cmd=export_quotation&list=DelQuotation";
