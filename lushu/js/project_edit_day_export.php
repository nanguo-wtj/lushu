<script>
    const vm =  new Vue({
        ...
        methods: {
            ...
            get_day:function (e) {
                var _that   =   this;
                const url   =   "<?=$_Post_url?>?cmd=export&list=GetDay";
            ...
            GetItinerary:function (e) {
                var _that   =   this;
                const url   =   "<?=$_Post_url?>?cmd=project_export&list=GetItinerary_day";
            ...
            chengeDay:function(e) {
                ...
                location.href   =   'project_edit_day_export.html?key_id='+this.key_id+'&day='+e.day+'&class=schedule';
            },
            ...
            Get_Day_traffic:function () {
                var _that   =   this;
                const url   =   "<?=$_Post_url?>?cmd=export&list=projectDayTraffic";
                post_url(url,{key_id:_that.key_id,day:_that.day},false,true).then(res => {
            ...
            Set_Transportation:function (e,a){
                ...
                e.Traffic = a.id;
                var _that   =   this;
                const url   =   "<?=$_Post_url?>?cmd=export&list=editprojectDayTraffic";
            ...
            Get_day_schedule:function () {
                var _that   =   this;
                const url   =   "<?=$_Post_url?>?cmd=export&list=GetProjectPoi";
                post_url(url,{key_id:_that.key_id,day:_that.day},false,true).then(res => {
            ...
            add_poi:function (e) {
                ...
                var _that   =   this;
                const url   =   "<?=$_Post_url?>?cmd=export&list=AddProjectPoi";
            ...
            Del_project_poi:function (e) {
                var _that   =   this;
                const url   =   "<?=$_Post_url?>?cmd=export&list=DelProjectPoi";
            ...
            editProjectPoisort:function (a,b,c) {
                var _that   =   this;
                const url   =   "<?=$_Post_url?>?cmd=export&list=editProjectPoisort";
                a   =   a+1;
                b   =   b+1;
            ...
            addTraffic:function (e) {
                ...
                $('#day_poi').hide();
                var _that   =   this;
                const url   =   "<?=$_Post_url?>?cmd=export&list=GetProjectTraffic";
            ...
            Editprojectdaytraffic:function (e) {
                ...
                // $('#day_poi').show();
                var _that   =   this;
                const url   =   "<?=$_Post_url?>?cmd=project_export&list=editProjectTraffic";
