    ...
    new Vue({
        ...
        methods: {
            ...
            GetItinerary:function (e) {
                var _that   =   this;
                const url   =   "<?=$_Post_url?>?cmd=project&list=GetItinerary_notes";
            ...
            add_project_note:function (e) {
                ...
                console.log(e)
                var _that   =   this;
                const url   =   "<?=$_Post_url?>?cmd=resource_edit&list=add_note_notes";
            ...
            del_project_note:function (e,c) {
                event.cancelBubble = true;
                var _that   =   this;
                const url   =   "<?=$_Post_url?>?cmd=resource_edit&list=del_note_notes";
                post_url(url,{key_id:_that.key_id,note_id:e.id},true).then(res => {
                    if(c){
            ...
            Post_content:function (){
                ...
                const url   =   "<?=$_Post_url?>?cmd=resource_edit&list=add_project_content_notes";
